...
zippycli/1.2.1 darwin-x64 node-v14.15.0
...
_See code: [src/commands/download.ts](https://github.com/JrMasterModelBuilder/zippycli/blob/v1.2.1/src/commands/download.ts)_
...
_See code: [src/commands/extract.ts](https://github.com/JrMasterModelBuilder/zippycli/blob/v1.2.1/src/commands/extract.ts)_
...
_See code: [src/commands/info.ts](https://github.com/JrMasterModelBuilder/zippycli/blob/v1.2.1/src/commands/info.ts)_
<!-- commandsstop -->
