...
zippycli/1.3.2 darwin-x64 node-v14.16.1
...
_See code: [src/commands/download.ts](https://github.com/JrMasterModelBuilder/zippycli/blob/v1.3.2/src/commands/download.ts)_
...
_See code: [src/commands/extract.ts](https://github.com/JrMasterModelBuilder/zippycli/blob/v1.3.2/src/commands/extract.ts)_
...
_See code: [src/commands/info.ts](https://github.com/JrMasterModelBuilder/zippycli/blob/v1.3.2/src/commands/info.ts)_
<!-- commandsstop -->
