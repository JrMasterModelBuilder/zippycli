...
_See code: [src/commands/download.ts](https://github.com/JrMasterModelBuilder/zippycli/blob/v1.4.0/src/commands/download.ts)_
...
_See code: [src/commands/extract.ts](https://github.com/JrMasterModelBuilder/zippycli/blob/v1.4.0/src/commands/extract.ts)_
...
_See code: [src/commands/info.ts](https://github.com/JrMasterModelBuilder/zippycli/blob/v1.4.0/src/commands/info.ts)_
<!-- commandsstop -->
